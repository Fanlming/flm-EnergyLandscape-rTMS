...
%%%%%%%%%%%%%%
%% this code was used to plot figure 3A, 3C, 4B, 4E, 4G, 4I
...
Fsimpost_Trans = sim_group_Trans;
...
Osimpost_Trans = sim_group_Trans;
...
figure;
subplot 131
imagesc(squeeze(mean(Bsim_Trans,1)));colorbar('limits',[0,0.0355])

subplot 132
imagesc(squeeze(mean(Fsimpost_Trans,1)));colorbar('limits',[0,0.0355])


subplot 133
imagesc(squeeze(mean(Osimpost_Trans,1)));colorbar('limits',[0,0.0355])
